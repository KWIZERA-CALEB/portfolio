...
const About = () => {
  return (
    <div className='flex justify-center items-center pt-[90px] pb-[60px]'>
      <div className="flex flex-col items-center space-y-[30px] md:space-x-[60px] justify-center lg:flex-row">
          <div>
              <img src="/images/yoo.jpg" className='w-[200px] h-[200px] rounded-[50%] object-cover object-center outline outline-offset-8 outline-sky-500 cursor-pointer image md:w-[280px] md:h-[280px] md:rounded-[30px]' alt="Image of Owner" />
          </div>
          <div>
            <h3 className="font-bold custom text-[32px] text-slate-800 text-center md:text-start">About Me</h3>
